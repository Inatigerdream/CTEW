...
def updatedatabase(fingerprintdf):
    ...
    fingerprintdf = fingerprintdf.rename(columns = {0:'efk_dsstox_compound_id'}) # not sure this will work
    mytable = pd.merge(df3, fingerprintdf, left_on='efk_dsstox_compound_id', right_on=fingerprintdf.columns[0])
