...
# build weather dic
fi = csv.reader(open("/home/rlougee/Desktop/all/west_nile/west_nile/input/weather.csv"))
...
# build train dic
fi = csv.reader(open("/home/rlougee/Desktop/all/west_nile/west_nile/input/train.csv"))
...
ids = []
fi = csv.reader(open("/home/rlougee/Desktop/all/west_nile/west_nile/input/test.csv"))
